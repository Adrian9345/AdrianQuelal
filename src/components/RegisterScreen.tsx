  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (msg.includes('auth/operation-not-allowed')) {
        setError('El registro con Correo/Contraseña no está habilitado en tu proyecto de Firebase. Activa "Correo electrónico/contraseña" (Email/Password) como proveedor de inicio de sesión en tu Consola de Firebase, o regístrate con Google.');
